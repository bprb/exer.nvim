...
function M.getRoot()
  ...
  local cmd = vim.loop.os_uname().sysname == 'Windows_NT'
    and 'git rev-parse --show-toplevel 2>NUL'
    or  'git rev-parse --show-toplevel 2>/dev/null'
  local gitRoot = vim.fn.systemlist(cmd)[1]
